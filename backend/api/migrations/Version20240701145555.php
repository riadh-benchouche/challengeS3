...
final class Version20240701145555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT NOT NULL, booked_by_id INT DEFAULT NULL, service_id INT DEFAULT NULL, employee_id INT DEFAULT NULL, beginning INT NOT NULL, duration INT NOT NULL, status VARCHAR(255) NOT NULL, reservation_date DATE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE service (id INT NOT NULL, establishment_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, duration INT NOT NULL, price INT NOT NULL, PRIMARY KEY(id))');
